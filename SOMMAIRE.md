...
/01. Introduction au C# et à l'écosystème .NET/1.1. Qu'est-ce que C# ?.md
/01. Introduction au C# et à l'écosystème .NET/1.2. Histoire et évolution de C#.md
/01. Introduction au C# et à l'écosystème .NET/1.3. Pourquoi choisir C# ?.md
/01. Introduction au C# et à l'écosystème .NET/1.4. Installation de l'environnement de développement.md
/01. Introduction au C# et à l'écosystème .NET/1.5. Vue d'ensemble de l'écosystème .NET.md
/01. Introduction au C# et à l'écosystème .NET/1.6. Votre premier programme "Hello World".md

## 1. [Introduction au C# et à l'écosystème .NET](/01. Introduction au C# et à l'écosystème .NET/README.md)
- 1.1. [Qu'est-ce que C# ?]()
...
/02. Fondamentaux du langage C#/2.1. Structure d'un programme C#.md
/02. Fondamentaux du langage C#/2.2. Types de données.md
/02. Fondamentaux du langage C#/2.3. Variables et constantes.md
/02. Fondamentaux du langage C#/2.4. Opérateurs.md
/02. Fondamentaux du langage C#/2.5. Structures de contrôle.md
/02. Fondamentaux du langage C#/2.6. Enregistrement des commentaires et documentation.md
## 2. [Fondamentaux du langage C#](/02. Fondamentaux du langage C#/README.md)
...
/03. Tableaux et collections/3.1. Tableaux.md
/03. Tableaux et collections/3.2. Collections standard.md
/03. Tableaux et collections/3.3. Collections spécialisées.md
...
/04. Méthodes et fonctions/4.1. Définition et appel de méthodes.md
/04. Méthodes et fonctions/4.2. Paramètres et valeurs de retour.md
/04. Méthodes et fonctions/4.3. Surcharge de méthodes.md
/04. Méthodes et fonctions/4.4. Paramètres optionnels et nommés.md
/04. Méthodes et fonctions/4.5. Méthodes d'extension.md
/04. Méthodes et fonctions/4.6. Méthodes locales (C# 7+).md
/04. Méthodes et fonctions/4.7. Expressions de fonction (lambdas).md
## 4. [Méthodes et fonctions](/04. Méthodes et fonctions/README.md)
...
/05. Programmation orientée objet en C#/5.10. Types par valeur (structs).md
/05. Programmation orientée objet en C#/5.1. Classes et objets.md
/05. Programmation orientée objet en C#/5.2. Propriétés et encapsulation.md
/05. Programmation orientée objet en C#/5.3. Constructeurs et finaliseurs.md
/05. Programmation orientée objet en C#/5.4. Héritage.md
/05. Programmation orientée objet en C#/5.5. Polymorphisme.md
/05. Programmation orientée objet en C#/5.6. Interfaces.md
/05. Programmation orientée objet en C#/5.7. Classes abstraites.md
/05. Programmation orientée objet en C#/5.8. Modificateurs d'accès.md
/05. Programmation orientée objet en C#/5.9. Records (C# 9+).md
## 5. [Programmation orientée objet en C#](/05. Programmation orientée objet en C#/README.md)
...
/06. Fonctionnalités avancées de C#/6.1. Délégués et événements.md
/06. Fonctionnalités avancées de C#/6.2. Expressions Lambda.md
/06. Fonctionnalités avancées de C#/6.3. LINQ (Language Integrated Query).md
/06. Fonctionnalités avancées de C#/6.4. Génériques.md
/06. Fonctionnalités avancées de C#/6.5. Gestion des exceptions.md
/06. Fonctionnalités avancées de C#/6.6. Types anonymes et dynamiques.md
/06. Fonctionnalités avancées de C#/6.7. Méthodes anonymes.md
/06. Fonctionnalités avancées de C#/6.8. Async⁄Await et programmation asynchrone.md
## 6. [Fonctionnalités avancées de C#](/06. Fonctionnalités avancées de C#/README.md)
...
/07. Windows Forms (WinForms)/7.1. Introduction à WinForms.md
/07. Windows Forms (WinForms)/7.2. Création d'une première application.md
/07. Windows Forms (WinForms)/7.3. Contrôles de base et leurs propriétés.md
/07. Windows Forms (WinForms)/7.4. Gestion des événements.md
/07. Windows Forms (WinForms)/7.5. Mise en page et design.md
/07. Windows Forms (WinForms)/7.6. Menus et barres d'outils.md
/07. Windows Forms (WinForms)/7.7. Dialogues et messages.md
/07. Windows Forms (WinForms)/7.8. Liaison de données (Data Binding).md
/07. Windows Forms (WinForms)/7.9. Multithreading dans WinForms.md
...
/08. Windows Presentation Foundation (WPF)/8.10. Personnalisation des contrôles.md
/08. Windows Presentation Foundation (WPF)/8.11. Localisation et internationalisation.md
/08. Windows Presentation Foundation (WPF)/8.1. Introduction à WPF.md
/08. Windows Presentation Foundation (WPF)/8.2. XAML et fondamentaux.md
/08. Windows Presentation Foundation (WPF)/8.3. Mise en page avec les Panels.md
/08. Windows Presentation Foundation (WPF)/8.4. Contrôles WPF.md
/08. Windows Presentation Foundation (WPF)/8.5. Styles et templates.md
/08. Windows Presentation Foundation (WPF)/8.6. Binding et DataContext.md
/08. Windows Presentation Foundation (WPF)/8.7. Commandes et MVVM (Model-View-ViewModel).md
/08. Windows Presentation Foundation (WPF)/8.8. Ressources et dictionnaires de ressources.md
/08. Windows Presentation Foundation (WPF)/8.9. Animations et effets visuels.md
...
/09. Accès aux données avec ADO.NET/9.1. Introduction à ADO.NET.md
/09. Accès aux données avec ADO.NET/9.2. Connexion aux bases de données.md
/09. Accès aux données avec ADO.NET/9.3. Exécution de commandes SQL.md
/09. Accès aux données avec ADO.NET/9.4. DataSet et DataAdapter.md
/09. Accès aux données avec ADO.NET/9.5. Transactions.md
/09. Accès aux données avec ADO.NET/9.6. Procédures stockées.md
## 9. [Accès aux données avec ADO.NET](/09. Accès aux données avec ADO.NET/README.md)
...
/10. Entity Framework Core/10.1. Introduction à Entity Framework Core.md
/10. Entity Framework Core/10.2. Approches de modélisation.md
/10. Entity Framework Core/10.3. DbContext et DbSet.md
/10. Entity Framework Core/10.4. Migrations.md
/10. Entity Framework Core/10.5. Requêtes LINQ to Entities.md
/10. Entity Framework Core/10.6. Relations entre entités.md
/10. Entity Framework Core/10.7. Chargement de données.md
/10. Entity Framework Core/10.8. Transactions et concurrence.md
...
- 10.2. [Approches de modélisation]()
    - 10.2.1. Code First
...
/11. Intégration avec MySQL MariaDB/11.1. Installation des connecteurs.md
/11. Intégration avec MySQL MariaDB/11.2. Configuration de la connexion.md
/11. Intégration avec MySQL MariaDB/11.3. CRUD avec MySQL⁄MariaDB.md
/11. Intégration avec MySQL MariaDB/11.4. Entity Framework Core avec MySQL⁄MariaDB.md
/11. Intégration avec MySQL MariaDB/11.5. Optimisation des performances.md
/11. Intégration avec MySQL MariaDB/11.6. Sécurité et bonnes pratiques.md
## 11. [Intégration avec MySQL/MariaDB](/11. Intégration avec MySQL MariaDB/README.md)
...
/12. Développement Web avec ASP.NET/12.1. Introduction à ASP.NET.md
/12. Développement Web avec ASP.NET/12.2. ASP.NET MVC.md
/12. Développement Web avec ASP.NET/12.3. ASP.NET Core.md
/12. Développement Web avec ASP.NET/12.4. Razor Pages.md
/12. Développement Web avec ASP.NET/12.5. API Web et services REST.md
/12. Développement Web avec ASP.NET/12.6. Documentation API avec Swagger⁄OpenAPI.md
/12. Développement Web avec ASP.NET/12.7. Authentification et autorisation.md
/12. Développement Web avec ASP.NET/12.8. Middleware et pipeline de requêtes.md
## 12. [Développement Web avec ASP.NET](/12. Développement Web avec ASP.NET/README.md)
...
/13. Applications de bureau modernes avec .NET/13.1. Windows App SDK (anciennement Project Reunion).md
/13. Applications de bureau modernes avec .NET/13.2. MAUI (Multi-platform App UI).md
/13. Applications de bureau modernes avec .NET/13.3. WinUI 3.md
/13. Applications de bureau modernes avec .NET/13.4. Applications de bureau empaquetées (MSIX).md
## 13. [Applications de bureau modernes avec .NET](/13. Applications de bureau modernes avec .NET/README.md)
...
/14. Déploiement et distribution/14.1. Compilation et build.md
/14. Déploiement et distribution/14.2. Déploiement d'applications Windows Forms.md
/14. Déploiement et distribution/14.3. Déploiement d'applications WPF.md
/14. Déploiement et distribution/14.4. Déploiement d'applications Web ASP.NET.md
/14. Déploiement et distribution/14.5. Publication avec ClickOnce.md
/14. Déploiement et distribution/14.6. Packaging MSIX.md
/14. Déploiement et distribution/14.7. Configurations de déploiement.md
## 14. [Déploiement et distribution](/14. Déploiement et distribution/README.md)
...
/15. Tests et qualité de code/15.1. Tests unitaires.md
/15. Tests et qualité de code/15.2. Mocking avec Moq.md
/15. Tests et qualité de code/15.3. Tests d'intégration.md
/15. Tests et qualité de code/15.4. Analyse de code et refactoring.md
/15. Tests et qualité de code/15.5. Débogage avancé.md
/15. Tests et qualité de code/15.6. Outils de qualité de code.md
## 15. [Tests et qualité de code](/15. Tests et qualité de code/README.md)
...
/16. Sécurité en C#/16.1. Gestion des chaînes de connexion.md
/16. Sécurité en C#/16.2. Protection contre les injections SQL.md
/16. Sécurité en C#/16.3. Cryptographie.md
/16. Sécurité en C#/16.4. Authentification et autorisation.md
/16. Sécurité en C#/16.5. Gestion sécurisée des secrets.md
/16. Sécurité en C#/16.6. Sécurité des applications Web.md
## 16. [Sécurité en C#](/16. Sécurité en C#/README.md)
...
/17. Performances et optimisation/17.1. Gestion de la mémoire.md
/17. Performances et optimisation/17.2. Garbage Collector.md
/17. Performances et optimisation/17.3. Multithreading et parallélisme.md
/17. Performances et optimisation/17.4. Optimisation des requêtes LINQ.md
/17. Performances et optimisation/17.5. Profilage des applications.md
/17. Performances et optimisation/17.6. Techniques d'optimisation avancées.md
## 17. [Performances et optimisation](/17. Performances et optimisation/README.md)
- 17.1. [Gestion de la mémoire]()
...
- 17.3. [Multithreading et parallélisme]()
...
- 17.4. [Optimisation des requêtes LINQ]()
...
- 17.5. [Profilage des applications]()
...
- 17.6. [Techniques d'optimisation avancées]()
...
/18. Interopérabilité/18.1. P⁄Invoke et appels de code natif.md
/18. Interopérabilité/18.2. COM Interop.md
/18. Interopérabilité/18.3. Intégration avec d'autres langages.md
/18. Interopérabilité/18.4. Intégration avec JavaScript⁄TypeScript.md
/18. Interopérabilité/18.5. Intégration cloud et services.md
## 18. [Interopérabilité](/18. Interopérabilité/README.md)
...
/19. Design Patterns en C#/19.1. Patterns créationnels.md
/19. Design Patterns en C#/19.2. Patterns structurels.md
/19. Design Patterns en C#/19.3. Patterns comportementaux.md
/19. Design Patterns en C#/19.4. Patterns architecturaux.md
/19. Design Patterns en C#/19.5. Patterns spécifiques à .NET.md
## 19. [Design Patterns en C#](/19. Design Patterns en C#/README.md)
- 19.1. [Patterns créationnels]()
  - 19.1.1. Singleton
...
/20. Projets pratiques/20.1. Application de gestion avec WinForms et MySQL.md
/20. Projets pratiques/20.2. Application CRUD avec WPF, MVVM et MariaDB.md
/20. Projets pratiques/20.3. Application Web complète avec ASP.NET Core.md
/20. Projets pratiques/20.4. API RESTful avec Entity Framework et Swagger.md
/20. Projets pratiques/20.5. Service Cloud avec Azure et .NET.md
## 20. [Projets pratiques](/20. Projets pratiques/README.md)
- 20.1. [Application de gestion avec WinForms et MySQL]()
...
- 20.2. [Application CRUD avec WPF, MVVM et MariaDB]()
...
- 20.3. [Application Web complète avec ASP.NET Core]()
...
- 20.4. [API RESTful avec Entity Framework et Swagger]()
...
- 20.5. [Service Cloud avec Azure et .NET]()
...
/21. Extensions et écosystème C#/21.1. Bibliothèques et frameworks populaires.md
/21. Extensions et écosystème C#/21.2. DevOps pour projets C#.md
/21. Extensions et écosystème C#/21.3. Tendances et évolutions futures de C#.md
## 21. [Extensions et écosystème C#](/21. Extensions et écosystème C#/README.md)
...
/22. Ressources et communauté/22.1. Documentation officielle.md
/22. Ressources et communauté/22.2. Communautés en ligne.md
/22. Ressources et communauté/22.3. Conférences et événements.md
/22. Ressources et communauté/22.4. Formation continue et certifications.md
/22. Ressources et communauté/22.5. Blogs et podcasts sur C# et .NET.md
/22. Ressources et communauté/22.6. Contribution open source.md
/22. Ressources et communauté/README.md
## 22. [Ressources et communauté](/22. Ressources et communauté/README.md)
